...
INSERT INTO APLICACION VALUES('GUNIX_ADMON','Gunix','Gunix.png');
        ...
        INSERT INTO MODULO VALUES('GUNIX_ADMON','APLICACIONES','Aplicaciones','window-128.png');
                INSERT INTO FUNCION(ID_APLICACION, ID_MODULO,ID_FUNCION,TITULO,DESCRIPCION,ORDEN) VALUES('GUNIX_ADMON','APLICACIONES','ADMINISTRACION','Administración','Menú con opciones de Administración de aplicaciones',1);

        INSERT INTO MODULO VALUES('GUNIX_ADMON','CONTACTO','Contactos','mail-128.png');
                INSERT INTO FUNCION(ID_APLICACION, ID_MODULO,ID_FUNCION,TITULO,DESCRIPCION,ORDEN) VALUES('GUNIX_ADMON','CONTACTO','ADMINISTRACION','Administración','Menú con opciones de Administración de contactos',1);

        INSERT INTO MODULO VALUES('GUNIX_ADMON','SOPORTE','Soporte','support-128.png');
                INSERT INTO FUNCION(ID_APLICACION, ID_MODULO,ID_FUNCION,TITULO,DESCRIPCION,ORDEN) VALUES('GUNIX_ADMON','SOPORTE','ADMINISTRACION','Administración','Menú con opciones de Administración de soporte',1);
                
        INSERT INTO ROL_FUNCION VALUES('GUNIX_ADMON','ADMINISTRADOR','CLIENTES','ADMINISTRACION','COMPLETO');
        INSERT INTO ROL_FUNCION VALUES('GUNIX_ADMON','ADMINISTRADOR','APLICACIONES','ADMINISTRACION','COMPLETO');

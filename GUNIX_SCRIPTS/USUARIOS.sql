...
INSERT INTO APLICACION VALUES('EJEMPLO_GUNIX','Aplicación Prueba 1');
        INSERT INTO ROL VALUES('EJEMPLO_GUNIX','SUPER_ADMIN','Rol que tiene acceso a todas las funcionalidades de todos los sistemas');
        INSERT INTO ROL VALUES('EJEMPLO_GUNIX','VACIO','Rol que no tiene acceso a nada');
        INSERT INTO USUARIO_ROL VALUES('bjvences@gmail.com','EJEMPLO_GUNIX','SUPER_ADMIN');
        INSERT INTO USUARIO_ROL VALUES('bjvences@gmail.com','EJEMPLO_GUNIX','VACIO');

        INSERT INTO MODULO VALUES('EJEMPLO_GUNIX','PIPP_ADMIN','Módulo de Administración Principal de PIPP');
                INSERT INTO FUNCION VALUES('EJEMPLO_GUNIX','PIPP_ADMIN','ADMIN_USUARIOS','Gestión de Usuarios');
                        INSERT INTO FUNCION(ID_APLICACION, ID_MODULO,ID_FUNCION,TITULO,PROCESS_KEY,ID_FUNCION_PADRE,ORDEN) VALUES('EJEMPLO_GUNIX','PIPP_ADMIN','ADMIN_USUARIOS_ALTA','Alta','AltaUsuario','ADMIN_USUARIOS',1.0);
                        INSERT INTO FUNCION(ID_APLICACION, ID_MODULO,ID_FUNCION,TITULO,PROCESS_KEY,ID_FUNCION_PADRE,ORDEN) VALUES('EJEMPLO_GUNIX','PIPP_ADMIN','ADMIN_USUARIOS_CONSULTA','Consulta','GestiónUsuario','ADMIN_USUARIOS',2.0);
                                INSERT INTO PARAM_FUNCION VALUES ('EJEMPLO_GUNIX','PIPP_ADMIN','ADMIN_USUARIOS_CONSULTA','soloLectura','true');

        INSERT INTO MODULO VALUES('EJEMPLO_GUNIX','PIPP_ADMIB','Módulo de Administración Secundario de PIPP');
                INSERT INTO FUNCION VALUES('EJEMPLO_GUNIX','PIPP_ADMIB','ADMIN_X','Gestión de X');
                        INSERT INTO FUNCION(ID_APLICACION,ID_MODULO,ID_FUNCION,TITULO,ID_FUNCION_PADRE,ORDEN) VALUES('EJEMPLO_GUNIX','PIPP_ADMIB','ADMIN_X2','X','ADMIN_X',1.0);
                                INSERT INTO FUNCION(ID_APLICACION,ID_MODULO,ID_FUNCION,TITULO,PROCESS_KEY,ID_FUNCION_PADRE,ORDEN) VALUES('EJEMPLO_GUNIX','PIPP_ADMIB','ADMIN_X2_A','X','ProcessKeyX','ADMIN_X2',1.0);

        INSERT INTO ROL_FUNCION VALUES('EJEMPLO_GUNIX','SUPER_ADMIN','PIPP_ADMIN','ADMIN_USUARIOS','COMPLETO');
        INSERT INTO ROL_FUNCION VALUES('EJEMPLO_GUNIX','VACIO','PIPP_ADMIB','ADMIN_X2_A');

INSERT INTO APLICACION VALUES('EJEMPLO_GUNIX2');
        INSERT INTO ROL VALUES('EJEMPLO_GUNIX2','NOT_SUPER_ADMIN','Rol2 que tiene acceso a todas las funcionalidades de todos los sistemas');
        INSERT INTO ROL VALUES('EJEMPLO_GUNIX2','NOT_VACIO','Rol2 que no tiene acceso a nada');
        INSERT INTO USUARIO_ROL VALUES('bjvences@gmail.com','EJEMPLO_GUNIX2','NOT_SUPER_ADMIN');
        INSERT INTO USUARIO_ROL VALUES('bjvences@gmail.com','EJEMPLO_GUNIX2','NOT_VACIO');

        INSERT INTO MODULO VALUES('EJEMPLO_GUNIX2','GUNIX_ADMIN','Módulo de Administración Principal de GUNIX');
                INSERT INTO FUNCION VALUES('EJEMPLO_GUNIX2','GUNIX_ADMIN','ADMIN_USUARIOS','Gestión de Usuarios');
                        INSERT INTO FUNCION(ID_APLICACION, ID_MODULO,ID_FUNCION,TITULO,PROCESS_KEY,ID_FUNCION_PADRE,ORDEN) VALUES('EJEMPLO_GUNIX2','GUNIX_ADMIN','ADMIN_USUARIOS_ALTA','Alta','AltaUsuario','ADMIN_USUARIOS',1.0);
                        INSERT INTO FUNCION(ID_APLICACION, ID_MODULO,ID_FUNCION,TITULO,PROCESS_KEY,ID_FUNCION_PADRE,ORDEN) VALUES('EJEMPLO_GUNIX2','GUNIX_ADMIN','ADMIN_USUARIOS_CONSULTA','Consulta','GestiónUsuario','ADMIN_USUARIOS',2.0);
                                INSERT INTO PARAM_FUNCION VALUES ('EJEMPLO_GUNIX2','GUNIX_ADMIN','ADMIN_USUARIOS_CONSULTA','soloLectura','true');

        INSERT INTO MODULO VALUES('EJEMPLO_GUNIX2','PIPP_ADMIB','Módulo de Administración Secundario de GUNIX');
                INSERT INTO FUNCION VALUES('EJEMPLO_GUNIX2','PIPP_ADMIB','ADMIN_X','Gestión de X');
                        INSERT INTO FUNCION(ID_APLICACION,ID_MODULO,ID_FUNCION,TITULO,ID_FUNCION_PADRE,ORDEN) VALUES('EJEMPLO_GUNIX2','PIPP_ADMIB','ADMIN_X2','X','ADMIN_X',1.0);
                                INSERT INTO FUNCION(ID_APLICACION,ID_MODULO,ID_FUNCION,TITULO,PROCESS_KEY,ID_FUNCION_PADRE,ORDEN) VALUES('EJEMPLO_GUNIX2','PIPP_ADMIB','ADMIN_X2_A','X','ProcessKeyX','ADMIN_X2',1.0);

        INSERT INTO ROL_FUNCION VALUES('EJEMPLO_GUNIX2','NOT_SUPER_ADMIN','GUNIX_ADMIN','ADMIN_USUARIOS','COMPLETO');
        INSERT INTO ROL_FUNCION VALUES('EJEMPLO_GUNIX2','NOT_VACIO','PIPP_ADMIB','ADMIN_X2_A');
...
h as(
	...
	from
		...
		USUARIO U ON (U.ID_USUARIO=UR.ID_USUARIO and U.ID_USUARIO= 'bjvences@gmail.com')--$1)
), 
q AS(
	SELECT
		H.*,

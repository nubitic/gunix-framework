...
public interface RolMapper {
	...
	@Delete("DELETE FROM SEGURIDAD.ROL_FUNCION WHERE ID_APLICACION = #{funcion.modulo.aplicacion.idAplicacion} AND ID_ROL = #{idRol} AND ID_MODULO = #{funcion.modulo.idModulo} AND ID_FUNCION = #{funcion.idFuncion}")

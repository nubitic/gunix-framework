...
public enum Context {
	...
	SOPORTE_DOCUMENTAL_ENABLED("SOPORTE_DOCUMENTAL_ENABLED","false"),
		//Implementación por LogicalDoc
		...
		//Implementación por Alfresco
		ALFRESCO_USER("ALFRESCO_USER",null),
		ALFRESCO_PASSWORD("ALFRESCO_PASSWORD",null),
		ALFRESCO_URL("ALFRESCO_URL",null),

...
public class Tutorial_1Wrapper implements org.openl.main.OpenLWrapper, org.openl.rules.context.IRulesRuntimeContextProvider, org.openl.rules.context.IRulesRuntimeContextConsumer {
	...
	public static java.lang.String __src = "mx/com/gunix/reglas/Tutorial_1.xls";

	public static java.lang.String __srcModuleClass = null;

	public static java.lang.String __folder = "rules";

	public static java.lang.String __project = "backEnd";
	...
	private ThreadLocal<org.openl.vm.IRuntimeEnv> __env = new ThreadLocal<org.openl.vm.IRuntimeEnv>() {
		...
		protected org.openl.vm.IRuntimeEnv initialValue() {
			...
			environment.setContext(org.openl.rules.context.RulesRuntimeContextFactory.buildRulesRuntimeContext());
			return environment;
		}
	};
	...
	static synchronized protected void __init() {
		...
		hello1_Method = __class.getMatchingMethod("hello1", new IOpenClass[] { OpenClassHelper.getOpenClass(__class, int.class) });
		hello2_Method = __class.getMatchingMethod("hello2", new IOpenClass[] { OpenClassHelper.getOpenClass(__class, int.class) });

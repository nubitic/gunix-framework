...
public class PersistentTokenBasedRememberMeServices extends AbstractRememberMeServices {
	...
	protected UserDetails processAutoLoginCookie(String[] cookieTokens, HttpServletRequest request, HttpServletResponse response) {
		...
		PersistentRememberMeToken token = (PersistentRememberMeToken) tokenRepository.getTokenForSeries(presentedSeries);
	...
	protected boolean rememberMeRequested(HttpServletRequest request, String parameter) {
		...
		if(paramValue==null&&request.getAttribute("_spring_security_remember_me")!=null){
			paramValue = request.getAttribute("_spring_security_remember_me").toString();
		}

package mx.com.gunix.ui.vaadin.view.aplicacion;
...
import mx.com.gunix.ui.vaadin.view.aplicacion.components.FuncionesTab;
import mx.com.gunix.ui.vaadin.view.aplicacion.components.ModuloForm;
import mx.com.gunix.ui.vaadin.view.aplicacion.components.RolForm;
...
public class AplicacionView extends AbstractGunixView<AplicacionView.AplicacionViewBean> implements SecuredView {
	...
	private static final String MODULOS_ROLES_WIDTH = "1250px";
	...
	private void addRolTab(Rol r) {
		...
		for (Modulo m : aplicacion.getModulos()) {
			...
			ft.addOrUpdateFuncionesModulo(m,
					esConsulta && (mRol = r.getModulos().stream().filter(moduloRol -> (moduloRol.getIdModulo().equals(m.getIdModulo()))).findFirst().orElse(null)) != null ? mRol : null);
		}
